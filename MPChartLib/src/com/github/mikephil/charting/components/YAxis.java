...
public class YAxis extends AxisBase {
    ...
    public String getFormattedLabel(int index) {
        ...
        if (index < 0 || index >= mEntries.length) {
            ...
            float currentLabel = mEntries[index];
            int digits = com.github.mikephil.charting.utils.Utils.getDecimals(currentLabel);
            ...
            String result = mFormat.format(currentLabel);
            Log.w(TAG,"label:"+currentLabel+",digits:"+digits+",result:"+result);
