...
import huoli.com.pgy.Activitys.KLineActivity;
import huoli.com.pgy.Activitys.LoginActivity;
import huoli.com.pgy.Activitys.MainActivity;
import huoli.com.pgy.Adapters.BuyOrSaleListAdapter;
...
import huoli.com.pgy.Models.Beans.EventBean.EventC2cCancelEntrust;
import huoli.com.pgy.Models.Beans.EventBean.EventGoodsChange;
import huoli.com.pgy.Models.Beans.EventBean.EventGoodsCoinChange;
...
import huoli.com.pgy.Receivers.GoodsListReceiver;
...
import huoli.com.pgy.Widgets.AmountView;
import huoli.com.pgy.Widgets.MyBottomSpinnerList;
import huoli.com.pgy.Widgets.MyLeftSecondarySpinnerList;
...
public class TradeGoodsFragment extends BaseFragment implements GoodsListReceiver.onListCallback, RadioGroup.OnCheckedChangeListener {
    ...
    private void switchBuyOrSale() {
        ...
        if (isBuy) {
            ...
            fragmentTradeGoodsPercentGroupForth.setBackgroundResource(R.drawable.selector_radio_bg_red_grey_right);
        }
    ...
    @OnClick({R.id.fragment_tradeGoods_c2cName, R.id.fragment_tradeGoods_limitOrMarket, R.id.fragment_tradeGoods_trade, R.id.fragment_tradeGoods_kline_frame, R.id.fragment_tradeGoods_login, R.id.fragment_tradeGoods_gear, R.id.fragment_tradeGoods_refresh})
        ...
        tradeItemListener = new spinnerSingleChooseListener() {
            ...
            public void onItemClickListener(int position) {
                ...
                if (!TextUtils.isEmpty(selectTrade)) {
                    tradePos = position;
                    fragmentTradeGoodsLimitOrMarket.setText(selectTrade);
                    switchLimitOrMarketPrice();
                }
            }
        };
