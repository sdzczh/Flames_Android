package huoli.com.pgy.Widgets.mychart;
...
public class CoupleChartGestureListener implements OnChartGestureListener {
    ...
    public CoupleChartGestureListener(View.OnTouchListener listener,Chart srcChart, Chart[] dstCharts) {
