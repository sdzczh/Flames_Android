...
public class KMAEntity {
     ...
     * @param n         几日均值
     */
    public KMAEntity(List<KLineBean.ListBean> kLineBeen, int n) {
     ...
     */
    public KMAEntity(List<KLineBean.ListBean> kLineBeen, int n, float defult) {
    ...
    public static float getLastMA(List<KLineBean.ListBean> datas, int n) {
