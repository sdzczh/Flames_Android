...
/**
 * Created by xuqingzhong on 2017/3/7.
 */
...
public class VMAEntity {
     ...
     * @param n         几日均值
     */
    public VMAEntity(List<KLineBean.ListBean> kLineBeen, int n) {
     ...
     */
    public VMAEntity(List<KLineBean.ListBean> kLineBeen, int n, float defult) {
    ...
    private static float getSum(Integer a, Integer b, List<KLineBean.ListBean> datas) {
        float sum = 0;
        for (int i = a; i <= b; i++) {
    ...
    public static float getLastMA(ArrayList<KLineBean.ListBean> datas, int n) {
