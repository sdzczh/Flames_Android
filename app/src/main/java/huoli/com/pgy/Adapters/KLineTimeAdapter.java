...
public class KLineTimeAdapter extends RecyclerView.Adapter<KLineTimeAdapter.StateHolder>{
    ...
    private huoli.com.pgy.Interfaces.getPositionCallback getPositionCallback;

    public void setGetPositionCallback(huoli.com.pgy.Interfaces.getPositionCallback getPositionCallback) {
