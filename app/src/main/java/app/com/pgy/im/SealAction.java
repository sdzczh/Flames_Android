...
import app.com.pgy.im.server.BaseAction;
import app.com.pgy.im.server.response.AddGroupMemberResponse;
import app.com.pgy.im.server.response.AgreeFriendsResponse;
import app.com.pgy.im.server.response.DeleteGroupMemberResponse;
import app.com.pgy.im.server.response.DismissGroupResponse;
import app.com.pgy.im.server.response.FriendInvitationResponse;
...
import app.com.pgy.im.server.response.GetUserInfoByIdResponse;
...
import app.com.pgy.im.server.response.JoinGroupResponse;
import app.com.pgy.im.server.response.LoginResponse;
import app.com.pgy.im.server.response.QiNiuTokenResponse;
import app.com.pgy.im.server.response.QuitGroupResponse;
import app.com.pgy.im.server.response.RegisterResponse;
import app.com.pgy.im.server.response.RemoveFromBlackListResponse;
import app.com.pgy.im.server.response.RestPasswordResponse;
import app.com.pgy.im.server.response.SendCodeResponse;
import app.com.pgy.im.server.response.SetFriendDisplayNameResponse;
import app.com.pgy.im.server.response.SetGroupNameResponse;
import app.com.pgy.im.server.response.SetGroupPortraitResponse;
import app.com.pgy.im.server.response.SetNameResponse;
import app.com.pgy.im.server.response.SetPortraitResponse;
import app.com.pgy.im.server.response.SyncTotalDataResponse;
import app.com.pgy.im.server.response.UserRelationshipResponse;
import app.com.pgy.im.server.response.VerifyCodeResponse;
import app.com.pgy.im.server.response.VersionResponse;
