...
public class ImageTextView extends AppCompatTextView {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        mScaleWidth = typedArray.getDimensionPixelOffset(R.styleable.ImageTextView_drawableWidth, MathUtils.dip2px(context,20));
        mScaleHeight = typedArray.getDimensionPixelOffset(R.styleable.ImageTextView_drawableHeight, MathUtils.dip2px(context,20));
     ...
     * 设置左侧图片并重绘
     */
    public void setDrawable(Context context ,int drawableRes) {
