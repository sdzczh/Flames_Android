...
public class RoundAngleFrameLayout extends FrameLayout {
    ...
    public RoundAngleFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            float radius = ta.getDimension(R.styleable.RoundAngleFrameLayout_framelayout_radius, 0);
            topLeftRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_framelayout_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_framelayout_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_framelayout_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_framelayout_bottomRightRadius, radius);
            ta.recycle();
        }
