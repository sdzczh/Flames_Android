...
//	public static final String HTTP_URL_DEBUG = "http://192.168.1.1:8080";
	//debug
	public static final String HTTP_URL = "http://47.89.49.120:5880";//http://api.pgy.pub
	public static final String HTTP_URL_DEBUG = "http://47.89.49.120:5880";//
	/**长连接host，测试、线上*/
	// release http://47.104.142.76:1606
			//denbug  192.168.2.165:1606 47.89.49.120:1606
	public static final String WS_URL_DEBUG = "ws://47.89.49.120:1606";//ws://47.56.87.149:1606
	public static final String WS_URL = "ws://47.89.49.120:1606";
	//debug
