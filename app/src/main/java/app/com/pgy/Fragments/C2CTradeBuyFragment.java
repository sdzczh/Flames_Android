...
import app.com.pgy.Widgets.MyViewPagerAdapter;

/**
 * 创建日期：2018/7/9 0009 on 下午 5:50
 * 描述:  C2C法币交易购买界面，包括普通和商家
 *
 * @author xu
 */

public class C2CTradeBuyFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener{
    private static C2CTradeBuyFragment instance;
    ...
    public static C2CTradeBuyFragment newInstance() {
        if (instance == null) {
            instance = new C2CTradeBuyFragment();
        }
        return instance;
    }
